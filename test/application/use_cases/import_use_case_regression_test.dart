...
void main() {
  ...
  test('cancellation requested during analysis keeps committed rows', () async {
    ...
    final analysis = _CancellingAnalysis(repository: repository, token: token);
    ...
    // 分析はトランザクション外で実行されるため、挿入済みレコードは
