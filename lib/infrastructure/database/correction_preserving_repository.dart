...
import '../../domain/models/lat_lng_e7.dart';
...
class CorrectionPreservingRepository extends KurashilogRepositoryImpl {
  ...
  Map<String, StoredCluster> _matchCorrections(
    ...
    // Exact stable-key matches are reserved before proximity matching, so an
    // earlier nearby cluster cannot steal a correction from the exact match.
    for (final cluster in rebuilt) {
